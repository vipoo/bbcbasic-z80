...
;
	...
	EXTERN	TK_ELSE, TK_OFF, TK_TERROR, TK_STEP, TK_LINE, TK_THEN, TK_TAB, TK_SPC, TK_TOR, TK_TAND, TK_TAB, TK_SPC
;
...
CMDTAB:
	...
	TKN_VECTOR(CLG)
	TKN_VECTOR(CLS)
	TKN_VECTOR_DIS(DATA, REM)
	TKN_VECTOR_DIS(DEF, REM)
	TKN_VECTOR(DIM)
	TKN_VECTOR(DRAW)	;DF
	TKN_VECTOR(END)
	TKN_VECTOR(ENDPRO)
