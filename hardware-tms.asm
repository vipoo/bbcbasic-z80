...
RTVHBIOSCFG:
	...
	PUSH	IX
	LD	BC, SYSGET_VDAFN
	LD	E, 0		; ASSUME INSTANCE 0 IS
	LD	D, 0		; FUNC 0 - NOT RELEVANT
	CALL_HBIOS		; DE NOW CONTAINS ADDR OF TMS DATA/CONFIG
	...
	LD	D, HCB_BIDUSR
	LD	E, HCB_BIDBIOS
	LD	HL, 2		; THE 2 BYTES OF THE PORT CONFIG MAP
	CALL_HBIOS		; PREPARE TO COPY 14 BYTES

	POP	HL		; RETRIEVE ADDR OF DATA IN HBIOS BANK
	LD	BC, 4		; SKIP FIRST 4 BYTES
	ADD	HL, BC
	LD	B, BF_SYSBNKCPY
	LD	DE, TMSDATA
	CALL_HBIOS

	LD	A, (TMS_DATREG)	; ALTER CODE TO USE CORRECT DATREG
	LD	(DATREG1), A
	LD	(DATREG2), A
	LD	(DATREG3), A
	LD	(DATREG4), A
