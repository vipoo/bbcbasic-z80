...
KEYWDL	EQU	KEYWDSEND - KEYWDS
	...
	PUBLIC	TK_TAND, TK_TDIV, TK_TEOR, TK_TMOD, TK_TOR
	PUBLIC	TK_LINE, TK_TOKLO, TK_TOKHI, TK_OFFSET, TK_THEN, TK_ELSE, TK_TERROR, TK_STEP, TK_SPC, TK_TAB, TK_OFF
