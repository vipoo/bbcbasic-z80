...
IFDEF FIRSTPASS
	...
	DEFC __LIST2 = 0
	DEFC __LIST2END = 0
	PUBLIC	CONST_KEYWDSEND
	PUBLIC	CONST_KEYWDS
	PUBLIC	CONST_LIST1
	PUBLIC	CONST_LIST1END
	PUBLIC	CONST_LIST2
...
PURGE:	LD	(HL),A		;CLEAR SCRATCHPAD
	...
	LD	DE, START ;- $100	; HIMEM IS OUT START MINUS A BUFFER
...
KEYWDS:	DEFB	80H
	...
	DEFM	" space"
CONST_KEYWDSEND:
KEYWDL	EQU	__KEYWDSEND - __KEYWDS 	; $-KEYWDS 	; RELOC-WORK-AROUND
	DEFW	-1
;
;ERROR MESSAGES:
;
...
LIST2:	DEFB	THEN
	DEFB	ELSE
CONST_LIST1END:
LIST1L	EQU	__LIST1END - __LIST1	; $-LIST1
	DEFB	REPEAT
	DEFB	TERROR
	DEFB	':'
CONST_LIST2END:
LIST2L	EQU	__LIST2END - __LIST2	;$-LIST2
;
