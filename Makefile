SRCS = main.asmpp exec.asmpp eval.asmpp fpp.asm hardware.asm hardware-sound.asmpp hardware-time.asm cpm.asm ram.asm tokens.asmpp hardware-tms.asmpp utils.asmpp tracing.asm
