...
TKE_FIRSTCMD	equ	$C6	; MUST ALIGN WITH VALUE IN MAIN.ASM

#define TKE_VECTOR()      				!
	PUBLIC	TKE_#1					!
TKE_#1:	EQU	TKE_FIRSTCMD - (FUNTBLEND - $) / 2	!
	DEFW	#1
...
FUNTBL:
	TKE_VECTOR(DECODE)	;Line number
	TKE_VECTOR(OPENIN)	;OPENIN 8E
	TKE_VECTOR(PTR)		;PTR	CF??
...
FUNTBLEND:
;
TCMD	EQU	FUNTOK + (FUNTBLEND - FUNTBL) / 2		; FUNTOK + ($ - FUNTBL) / 2 ; RELOC-WORK-AROUND
;
AND	EQU	80H
DIV	EQU	81H
EOR	EQU	82H
